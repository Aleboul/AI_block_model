...
for mixing in char_mixing:
    ...
    for index, model in enumerate(char_model):
        ...
        #axis[index].plot(m, exact_recov_rate_HC_1600, marker='P', linestyle='solid',
        #                 markerfacecolor='#B6BFE0', label='Oracle-HC-1600', c='#6E7FC2')
        #axis[index].plot(m, exact_recov_rate_SKmeans_1600, marker='*', linestyle='solid',
        #                 markerfacecolor='#C0CCC5', label='Oracle-SKmeans-1600', c='#819A8C')
        axis[index].plot(m, exact_recov_rate_ECO_200, marker='D', linestyle='dotted',
                         markerfacecolor='#EFAD9A', label='ECO-200', c='#DF5C35')
        axis[index].plot(m, exact_recov_rate_ECO_1600, marker='D', linestyle='solid',
    ...
    figure.suptitle('F1', ha='left', va='center', x=0.05,
                    y=0.5, rotation=90, fontsize=14)
    figure.set_size_inches(15, 5)
    figure.savefig(mixing + "_m.pdf")
