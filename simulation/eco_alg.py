...
def theta(R):
    """
    This function computes the w-madogram, a statistical tool used in extreme value theory to 
    ...
    Outputs
    -------
    w-madogram (float) : The computed w-madogram value, which is a measure of variability and dependence 
    ...
    # Transform the madogram value into the w-madogram result using a specific formula
    value = (mado + 1/2) / (1/2 - mado)

    return value  # Return the w-madogram value
