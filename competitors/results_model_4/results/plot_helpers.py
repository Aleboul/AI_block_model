...
colors = ['#EF476F', '#118AB2', '#06D6A0', '#073B4C', '#FFD166', "#FFACBB", "#33ACD4"]
...
def marker_settings(edgecolor, markersize=10):
    return dict(color = edgecolor, markerfacecolor='white', markeredgecolor=edgecolor, markersize=markersize, markeredgewidth=2)
