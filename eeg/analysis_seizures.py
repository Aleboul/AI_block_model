...
The analysis is performed where seizures are observed.

We calibrate the threshold according to the SECO value. We find no drops for this score metric. It 
hints that the trivial cluster $\{1,\dots,d\}$ is the unique relevant candidate. Furthermore, at first
look of the extremal correlation matrix or the time series, it is striking that all time series are
dependent.

We hence plot the matrix of extremal correlation obtained. One cluster is thus depicted.
"""
...
O_hat = clust(chi-10e-10, n=1000, alpha=_tau_[ind])
