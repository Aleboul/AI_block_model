...
# 'alpha' parameter is set to the second optimal value found previously (0.38]).
O_hat = eco_alg.clust(chi, n=n, alpha=0.38)
...
# Step 14: Save the plot as a PDF file in the 'results/wo_seizures/' directory.
...
# Step 16: Save the plot as a PDF file in the 'results/wo_seizures/' directory.
